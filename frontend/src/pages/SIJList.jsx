...
const printReceiptBrowser = (tx, plate) => {
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="space-y-1">
                    ...
                    <p
                      className={`font-mono ${selectedTx.category === "premium" ? "text-amber-400" : "text-zinc-300"}`}
                    >
                ...
                <div
                  className={`rounded-lg p-3 text-center border ${selectedTx.category === "premium" ? "bg-amber-900/20 border-amber-500/20" : "bg-emerald-900/20 border-emerald-500/20"}`}
                >
                  <div
                    className={`text-xs mb-1 ${selectedTx.category === "premium" ? "text-amber-400/70" : "text-emerald-400/70"}`}
                  >
                    Total Pembayaran (
                    {selectedTx.category === "premium" ? "Premium" : "Standar"})
                  </div>
                  <div
                    className={`text-xl font-bold font-mono ${selectedTx.category === "premium" ? "text-amber-400" : "text-emerald-400"}`}
                  >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    onClick={() => {
                      ...
                      printReceiptBrowser(selectedTx, nopol);
                    }}

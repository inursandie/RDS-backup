...
## Overview
RAJA Digital System v1.0 - A driver management and SIJ (Surat Izin Jalan) transaction system for Soetta Airport. Built with a React frontend and FastAPI backend using Supabase PostgreSQL database.
